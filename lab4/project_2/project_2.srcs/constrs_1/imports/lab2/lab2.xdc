...
set_property IOSTANDARD LVCMOS33 [get_ports {btns_4bit_tri_io[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {btns_4bit_tri_io[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {btns_4bit_tri_io[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {btns_4bit_tri_io[0]}]
